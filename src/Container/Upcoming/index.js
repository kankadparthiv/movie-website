...
const  UPCOMING = ()=>{
    ...
    const GetDataTrending = async ()=>{
        ...
        const {data}=await axios.get(`https://api.themoviedb.org/3/movie/upcoming?api_key=${API_KEY}&page=${pageno}&with_generes&languge=en-US&with_generes=""`);
            ...
            <Container>
                <Row>
                    <Col className='col-12'>
                        <section>
                            <h1 className='txtCenter'>Top Upcoming Movies</h1>
